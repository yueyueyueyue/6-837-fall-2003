...
var path = rootPath + 'common/images/jquerybubblepopup-theme';
    ...
    $("img[src$='icon-question-gir.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        ...
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>GIR</strong>: General Institute Requirement; course requirements that all undergraduates at MIT must fulfill. <a href="http://web.mit.edu/catalog/overv.chap3-gir.html">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-iap.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        ...
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>IAP</strong>: Independent Activities Period; a special term between MIT\'s Fall and Spring semesters that runs from early January through the end of January or early February. <a href="http://web.mit.edu/iap/">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-urop.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        ...
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>UROP</strong>: Undergraduate Research Opportunities Program. <a href="http://web.mit.edu/urop/">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-hass.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        ...
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>HASS</strong>: Every MIT undergraduate is required to take eight courses in Humanities, Arts, and Social Sciences. <a href="http://web.mit.edu/hassreq/">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-hass-s.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        ...
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>HASS-S</strong>: Humanities, Arts, and Social Sciences - Social Sciences.  <a href="http://web.mit.edu/hassreq/index.html#hasscatdef">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-cim.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        ...
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>CI-M</strong>: Communication Intensive in the Major; classes designed to teach the specific form of communication relevant to the field\'s professional and academic culture.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-cih.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        ...
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>CI-H</strong>: Communication Intensive in the Humanities, Arts and Social Sciences; <a href="http://web.mit.edu/commreq/faculty%20ci-h.html#CI-H%20Subjects">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
    ...
    $("img[src$='icon-question-cihw.png']").each(function(){               
         $(this).CreateBubblePopup({
                                        ...
                                        alwaysVisible: false,
                                        selectable: true,
                                        innerHtml: '<strong>CI-HW</strong>: Communication Intensive in the Humanities, Arts and Social Sciences - Writing Focused; <a href="http://web.mit.edu/commreq/faculty%20ci-h.html#CI-HW%20Subjects">Learn more</a>.',
                                        innerHtmlStyle: {
                                                            color:'#000000', 
                                                            'text-align':'left'
                                                        },
