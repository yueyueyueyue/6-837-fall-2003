...
#include "transform.h"
//#include "box.h"
#define WHH_PI       3.14159265358979323846
#define DegreesToRadians(x) ((WHH_PI * x) / 180.0f)
...
void SceneParser::parsePhongMaterials() {
  char token[MAX_PARSER_TOKEN_LENGTH];
  ...
  materials = new PhongMaterial[num_materials];
